...
dataset_list = []
for data in [dataset]:
#for data in ['insert_dataset','gpn_finetune_embed','gpn_human_embed','gpn_plant_embed']:
#for data in ['gpn_human_embed','gpn_plant_embed']:

    dataset = '/home/amber/multitask_RNA/data/rna_stable/' + data + '.h5'
    ...
    for i in range(1,11):
        ...
        sample_data = np.random.randint(0,len(x_train),dataset_size)
...
save_name = './rep_result/small_lr_rep_'+data+'.pkl'
